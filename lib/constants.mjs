...
export const LABEL_PRODUCT_UPDATES_TURBOTAX = 'Product Updates/TurboTax Promos';
export const LABEL_PRODUCT_UPDATES_EXPERIAN = 'Product Updates/Experian Promos';
...
export const LABEL_MEETUP_EVENTS = 'Meetup Events';
...
/** Streaming/media marketing (new arrivals, win-back offers) — the org side is Organization/BigTech/Streaming */
...
export const LABEL_ADVOCACY_KAW_BOARD = 'Advocacy/KAW Board';
...
export const LABEL_ORG_DEVELOPER_TOOLS = 'Organization/DeveloperTools';
export const LABEL_ORG_GOVERNMENT = 'Organization/Government';
export const LABEL_ORG_BIG_TECH = 'Organization/BigTech';
export const LABEL_ORG_DIGITAL_NOMAD = 'Organization/DigitalNomad';
...
/**
 * BigTech members are schema.org SoftwareApplication; sub-sectors below are named for
 * the applicationCategory / applicationSubCategory they map to.
 */
export const LABEL_ORG_BIGTECH_STREAMING = `${LABEL_ORG_BIG_TECH}/Streaming`;
export const LABEL_ORG_BIGTECH_ENTERTAINMENT = `${LABEL_ORG_BIG_TECH}/Entertainment`;
export const LABEL_ORG_BIGTECH_DEVELOPER_AI = `${LABEL_ORG_BIG_TECH}/Developer/AI`;
...
export const LABEL_ORG_LC_SPORTS = `${ORG_LOCAL}/SportsOrganization`;
