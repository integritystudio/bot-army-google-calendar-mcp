...
const PRODUCT_UPDATES_SUBLABELS = [
  LABEL_PRODUCT_UPDATES_CHATGPT, LABEL_PRODUCT_UPDATES_EXPERIAN, LABEL_PRODUCT_UPDATES_TURBOTAX,
];
...
const STANDALONE_LABELS = [
  LABEL_MEETUP_EVENTS, LABEL_COMMUNITY_EVENTS, LABEL_LINKEDIN_UPDATES,
...
const PROMOTIONS_LABELS = [
  ...
  LABEL_PROMOTIONS_ENTERTAINMENT, LABEL_PROMOTIONS_HEALTH,
];
...
const ADVOCACY_SUBLABELS = [LABEL_ADVOCACY_POLITICAL, LABEL_ADVOCACY_NONPROFIT, LABEL_ADVOCACY_KAW_BOARD];
