...
/**
 * Organization sender tags — data only, no Gmail client and no CLI.
 *
 * create-org-tags.mjs applies these; audit-org-tag-coverage.mjs and build-jsonld.mjs
 * read them. Keeping the definitions here means those readers do not load googleapis
 * or the tag-application engine just to inspect the config.
 */
import {
