...
user label; and a sender's domain does not reveal its org type — every name-based guess so
far has been wrong, with the running tally and examples kept only in the README.
