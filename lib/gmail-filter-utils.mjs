...
// Flag-to-label-change mapping lives in the shared core so the MCP handlers and these
// scripts cannot drift apart on it. Re-exported here because create-filters.mjs already
// imports its other filter-building helpers from this module.
export { buildLabelChange } from '../src/shared/gmail-core.ts';
