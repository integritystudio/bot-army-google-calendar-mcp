...
MJS_ROOT_REPO_FILE="$OUT_DIR/$MJS_ROOT_FILE.xml"
...
MJS_ROOT_FILE_NAME="$OUTPUT_PATH/$MJS_ROOT_FILE.xml"
...
MJS_ROOT_SCRIPT="$INPUT_DIR$MJS_ROOT_FILE.sh"
...
echo "Generating root .mjs repomix file for $PROJECT_DIR at $MJS_ROOT_FILE_NAME"
bash "$MJS_ROOT_SCRIPT" "$ROOT" "$MJS_ROOT_REPO_FILE"
echo "Success!"
echo
...
print_artifact "$MJS_ROOT_REPO_FILE" "$MJS_ROOT_FILE_NAME"
